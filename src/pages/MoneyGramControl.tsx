...
const MoneyGramControl = () => {
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      // Update just the MoneyGram settings
      allSettings.games = {
        ...allSettings.games,
        MoneyGram: settings
      };
      ...
      toast({
        ...
        description: "Money Gram game settings have been updated.",
        duration: 3000,
      });
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-800 to-green-950 flex flex-col">
      ...
      <main className="flex-1 p-4 max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <Button
            variant="outline"
            onClick={() => navigate('/game/moneygram')}
            className="flex items-center gap-2"
          >
            <ArrowLeft size={16} /> Back to Game
          </Button>
          <h1 className="text-2xl font-bold text-white">Money Gram Game Settings</h1>
          <Button 
...
export default MoneyGramControl;
